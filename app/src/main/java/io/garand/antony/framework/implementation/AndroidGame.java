...
import io.garand.antony.framework.Audio;
import io.garand.antony.framework.FileIO;
...
public abstract class AndroidGame extends Activity implements Game {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int frameBufferWidth = isPortrait ? 720: 1280; //Grandeur d'écran de mon Zenfone 6
